...
set serveroutput on;
CREATE OR REPLACE PROCEDURE FoodAdmin.P_REGISTRO_PRODUCTO(
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_CANT_PRODUCTO(PARAM_ID_PRODUCTO IN number, PARAM_CANT IN number)
AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_PREC_PRODUCTO(PARAM_ID_PRODUCTO IN number, PARAM_PRECIO IN number)
AS 
BEGIN
  UPDATE FoodAdmin
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_PRODUCTO(PARAM_ID_PRODUCTO IN number, PARAM_VALOR IN number, PARAM_OPCION IN NUMBER)
AS 
BEGIN
...
EXECUTE  FoodAdmin.P_MODIFICAR_PRODUCTO(5, 150, 1);


CREATE OR REPLACE PROCEDURE FoodAdmin.P_ELIMINAR_PRODUCTO(PARAM_ID_PRODUCTO IN number)
AS 
BEGIN
  DELETE FoodAdmin.PRODUCTO WHERE FoodAdmin.PRODUCTO.ID_PRODUCTO=PARAM_ID_PRODUCTO;
END;

EXECUTE  FoodAdmin.P_ELIMINAR_PRODUCTO(5);


----PROCEDIMIENTOS ALMACENADOS PARA AGREGAR/ELIMINAR Y MODIFICAR CLIENTES/EMPLEADOS----
     
CREATE OR REPLACE PROCEDURE FoodAdmin.P_REGISTRO_PERSONA(PARAM_PRIM_NOMBRE IN VARCHAR2,
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_REGISTRO_CLIENTE(PARAM_ID_PERSONA IN NUMBER)
AS
BEGIN
    INSERT INTO FoodAdmin.CLIENTE (ID_PERSONA)VALUES(PARAM_ID_PERSONA);
END;

CREATE OR REPLACE PROCEDURE FoodAdmin.P_REGISTRO_EMPLEADO(PARAM_HORAS_LAB IN NUMBER, 
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_CORREO(PARAM_ID_PERSONA IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_TELEFONO(PARAM_ID_PERSONA IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_DIRECCION(PARAM_ID_PERSONA IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_PERSONA(PARAM_ID_PERSONA IN NUMBER, PARAM_OPCION IN NUMBER, PARAM_VALOR IN NUMBER)
AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_ELIMINAR_PERSONA(PARAM_ID_PERSONA IN number)
AS 
BEGIN
  DELETE FoodAdmin.PERSONA WHERE FoodAdmin.PERSONA.ID_PERSONA=PARAM_ID_PERSONA;
END;

CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_HORASLAB(PARAM_ID_EMPLEADO IN NUMBER, PARAM_HORASLAB IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_CARGO(PARAM_ID_EMPLEADO IN NUMBER, PARAM_IDCARGO IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_SUCURSAL(PARAM_ID_EMPLEADO IN NUMBER, PARAM_IDSUCUR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_EMPLEADO(PARAM_ID_PERSONA IN NUMBER, PARAM_OPCION IN NUMBER, PARAM_VALOR IN NUMBER)
AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_ELIMINAR_EMPLEADO(PARAM_ID_EMPLEADO IN number)
AS 
BEGIN
  DELETE FoodAdmin.EMPLEADO WHERE FoodAdmin.EMPLEADO.ID_PERSONA=PARAM_ID_EMPLEADO;
END;

CREATE OR REPLACE PROCEDURE FoodAdmin.P_ELIMINAR_CLIENTE(PARAM_ID_CLIENTE IN number)
AS 
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_REGISTRO_PROVEEDOR(PARAM_NOMBRE_EMP IN VARCHAR2,
                                                  PARAM_ID_CORREOE IN NUMBER,
                                                  PARAM_ID_TEL IN NUMBER,
                                                  PARM_ID_DIREC IN NUMBER)
AS 
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_ELIMINAR_PROVEEDOR (PARAM_ID_PROVEEDOR IN number)
AS 
BEGIN
  DELETE FoodAdmin.PROVEEDOR WHERE FoodAdmin.PROVEEDOR.ID_PROVEEDOR=PARAM_ID_PROVEEDOR;
END;

CREATE OR REPLACE PROCEDURE FoodAdmin.P_PROV_MODIFICAR_CORREO(PARAM_ID_PROVEEDOR IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_PROV_MODIFICAR_TELEFONO(PARAM_ID_PROVEEDOR IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_PROV_MODIFICAR_DIRECCION(PARAM_ID_PROVEEDOR IN NUMBER, PARAM_VALOR IN NUMBER)
AS
BEGIN
...
CREATE OR REPLACE PROCEDURE FoodAdmin.P_MODIFICAR_PROVEEDOR(PARAM_ID_PROVEEDOR IN NUMBER, PARAM_OPCION IN NUMBER, PARAM_VALOR IN NUMBER)
AS 
BEGIN
...
END;
-------------------INVENTARIO-----------------------------------------
CREATE VIEW FoodAdmin.INVENTARIO AS
